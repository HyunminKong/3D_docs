...
| [EXP-006](EXP-006_trainable_3d_atom_risk_routing.md) | Can a trainable 3D atom head and future-utility/risk objective generalize without oracle poses? | Planned; v2 protocol locked | Implementation next; validation remains unopened for selection. |
